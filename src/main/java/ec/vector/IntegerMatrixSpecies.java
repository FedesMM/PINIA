...
public class IntegerMatrixSpecies extends MatrixSpecies {
    ...
    private final static String RUTA_TAREAS="ruta-tareas";
    private final static String RUTA_CANT_TAREAS="ruta-cantidad-tareas";
    private final static String RUTA_CANT_EMPLEADOS="ruta-cantidad-empleados";
    private final static String RUTA_EMPLEADOS="ruta-empleados";
    ...
    public boolean inNumericalTypeRange(double geneVal) {
        ...
        } else if (i_prototype instanceof IntegerMatrixIndividual) {
