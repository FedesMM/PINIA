...
public class Uso {
    ...
    public int getDuracionEstaciones() {
        return duracionEstaciones;
    }
    ...
    public float getProductividadTotal() {
        return productividadTotal;
    }
    ...
    public float[] getFosforoEstacion() {
    ...
    public List<Integer> getSiguientesUsos() {
        return siguientesUsos;
    }
